...
Members of the team will present regularly at international conferences, such as the International Environmetrics Society (TIES) Conference.  Invited sessions on the CRT's work will be proposed annually for the SSC conference.  By the end of the three year grant period, we will have an R package implementing bcGAIM with worked examples.  Material for a short course will be written and offered as one-day workshops.  Specific papers are listed in the Schedule of Events below.
...
- Winter 2022
    - Completion of first bcGAIM manuscript for applied stats journal (i.e. _JRSSC_)
- Spring 2022 
    - First applied paper on AQHI submitted to Health Canada for approval
...
- Winter 2023
    - Monotone bcGAIM methods paper completed (i.e. _JCGS_)
    - PC Priors for bcGAIM paper submitted (i.e. _Bayesian Analysis_)
- Spring 2023
    - INLA-like algorithm methods paper submitted to statistical journal (i.e. _Statistics in Medicine_)
    - Draft of epidemiological paper on short term pollution and COVID-19 submitted (i.e. _BMJ Open_)
    - 1 day group meeting and invited session at SSC conference
- Summer 2023
    - Software paper on bcGAIM package submitted (i.e. _Journal of Statistical Software_)
- Fall 2023
    - Second applied AQHI paper submitted to Health Canada for approval
- Winter 2024
    - Epidemiological paper on acute mortality submitted to high impact journal (i.e. _Lancet_)
...
ANYTHING BELOW THAT'S IMPORTANT BUT NOT INCLUDED ABOVE?
